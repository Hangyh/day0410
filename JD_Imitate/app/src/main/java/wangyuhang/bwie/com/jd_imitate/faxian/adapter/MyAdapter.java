package wangyuhang.bwie.com.jd_imitate.faxian.adapter;
...
public class MyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            simpleDraweeView = itemView.findViewById(R.id.sdv_iv);
            textView = itemView.findViewById(R.id.tv_titile);
            textView2 = itemView.findViewById(R.id.tv_date);
        }
    }
    public class MyViewHolder2 extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder2(View itemView) {
            ...
            simpleDraweeView = itemView.findViewById(R.id.sdv_iv2);
            simpleDraweeView2 = itemView.findViewById(R.id.sdv_iv22);
            textView = itemView.findViewById(R.id.tv_titile2);
            textView2 = itemView.findViewById(R.id.tv_date2);
        }
    }
    public class MyViewHolder3 extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder3(View itemView) {
            ...
            simpleDraweeView = itemView.findViewById(R.id.sdv_iv3);
            simpleDraweeView2 = itemView.findViewById(R.id.sdv_iv31);
            simpleDraweeView3 = itemView.findViewById(R.id.sdv_iv32);
            textView = itemView.findViewById(R.id.tv_titile3);
            textView2 = itemView.findViewById(R.id.tv_date3);
        }
    }
